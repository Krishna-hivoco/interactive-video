...
//         }`}>
//         <h3 className={`text-5xl font-normal uppercase ${myFont.className}`}>choose language</h3>
//         <div className='flex gap-3 text-3xl font-normal'>
//           <div
//             onClick={() => handleLanguageSelect('hindi')}
//             className='flex flex-col justify-center backdrop-blur-xs items-center gap-1 w-44 h-44 rounded-2xl bg-[#00000080] cursor-pointer hover:bg-[#00000099] transition-colors'
//           >
//             <strong className='text-4xl font-normal'>
//               अ
//             </strong>
//             <strong className={`font-normal text-3xl ${myFont.className}`}>
//               Hindi
//             </strong>
//           </div>
//           <div
...
//       <div
//         className={`absolute top-10 left-1/2 w-24 h-24 transition-all duration-500 ease-in ${showLanguage && !showVideo ? 'opacity-100' : 'opacity-0'
//           }`}
//         style={{ transitionDelay: '200ms' }}
//       >
//         <Image
...
//       <div
//         className={`absolute bottom-44 left-96 w-24 h-24 transition-all duration-500 ease-in ${isLoaded && !showVideo ? 'translate-x-0 opacity-100' : '-translate-x-52 opacity-0'
//           }`}
...
//       <div
//         className={`absolute bottom-2/5 right-96 w-24 h-24 transition-all duration-500 ease-in ${isLoaded && !showVideo ? 'translate-x-0 opacity-100' : 'translate-x-52 opacity-0'
//           }`}
//         style={{ transitionDelay: '1000ms' }}
//       >
...
//               {/* <div className='w-[252] h-[84px]  rounded-xl bg-white'>
//                 <div className='w-[252] h-[73px]  rounded-xl bg-[#cb9e6c]'></div>
//               </div>
//               <div className='w-[252] h-[84px]  rounded-xl bg-white'>
//                 <div className='w-[252] h-[73px]  rounded-xl bg-[#cb9e6c]'></div>
//               </div> */}
...
//                   <div onClick={() => handleAnswerSelect(option.label)} className={`w-[252] h-[73px] text-2xl ${myFont.className} rounded-xl  text-white flex justify-start items-center px-4 ${selectedAnswer === option.label
//                     ? option.isCorrect
//                       ? 'bg-[#76df57] '
//                       : 'bg-[#ff5e5e]'
...
export default function TaxFilePage() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Envelope - Center Bottom */}
      <div
        className={`absolute bottom-44 left-96 w-24 h-24 transition-all duration-500 ease-in ${isLoaded && !showVideo ? 'translate-x-0 opacity-100' : '-translate-x-32 opacity-0'
          }`}
        style={{ transitionDelay: '800ms' }}
      >
        <Image fill src="/envelope.svg" alt="Envelope" className="w-full h-full object-contain" />
      ...
      <div
        className={`absolute bottom-2/5 right-96 w-24 h-24 transition-all duration-500 ease-in ${isLoaded && !showVideo ? 'translate-x-0 opacity-100' : 'translate-x-32 opacity-0'
          }`}
        style={{ transitionDelay: '800ms' }}
      >
        <Image fill src="/pin.svg" alt="Envelope" className="w-full h-full object-contain" />
        ...
        <div className={`absolute bottom-0 left-0 right-0 h-screen z-30 bg-black/80 backdrop-blur-sm transition-all duration-[600ms] ease-in ${showQuiz ? 'translate-y-0' : 'translate-y-full'
          ...
          <div className=' max-w-lg mx-auto py-20 text-center relative'>
            ...
            <div className="relative w-full  h-full aspect-video ">
              ...
              {showConfetti && (
                <div className="absolute -right-48 top-1/2 -translate-y-1/2 w-96 h-96 rotate-[180] z-40 pointer-events-none">
                  <Image
                    src="/Confetti.gif"
                    alt="Confetti"
                    fill
