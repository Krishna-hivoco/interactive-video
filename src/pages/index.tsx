      ...
      {showVideo && (
        <div className="absolute inset-0 z-20">
          ...
          <button
            ...
            className="absolute top-6 left-6 z-30 bg-black/50 hover:bg-black/70 text-white p-3 rounded-full transition-all duration-300 hover:scale-110 backdrop-blur-sm"
            aria-label="Go back"
          >
            <svg
